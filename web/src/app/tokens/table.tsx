    ...
    const columns = useMemo(
        () =>
            col.columns([
                ...
                col.display({id: 'supply', header: 'Total supply', meta: {align: 'right', cellClassName: 'font-mono'}, cell: ({row}) => fmtBalance(row.original.totalSupply, row.original.decimals ?? 0, row.original.symbol ?? undefined)}),
